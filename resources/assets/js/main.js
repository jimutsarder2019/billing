  ...
  $(function () {
    ...
    if (searchInput.length) {
      ...
      searchInput.each(function () {
        var auth_user_type = $('input[name="auth_user_type"]')[0].value;
        var auth_user_id = $('input[name="auth_user_id"]')[0].value;
        ...
        searchInput
          .typeahead(
            ...
            // Members
            {
              ...
              templates: {
                header: '<h6 class="suggestions-header text-primary mb-0 mx-3 mt-3 pb-2">Customers</h6>',
                suggestion: function ({ name, subtitle, url, customer_for, manager_id }) {

                  if (auth_user_type == 'franchise') {
                    if (customer_for == 'franchise' && auth_user_id == manager_id) {
                      return (
                        `<a href="${url}">
                ...
                notFound:
                  ''
                // '<div class="not-found px-3 py-2">' +
                // '<h6 class="suggestions-header text-primary mb-2">Customers</h6>' +
                // '<p class="py-2 mb-0"><i class="ti ti-alert-circle ti-xs me-2"></i> No Results Found</p>' +
                // '</div>'
              }
            },
            // Managers
            {
              ...
              display: 'name',
              limit: 4,
              source: filterConfig(searchData.managers),
              templates: {
                header: '<h6 class="suggestions-header text-primary mb-0 mx-3 mt-3 pb-2">Managers</h6>',
