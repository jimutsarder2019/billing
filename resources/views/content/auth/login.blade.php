        ...
        <div class="authentication-inner py-4">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- /Logo -->
                    <h4 class="mb-1 pt-2">Welcome to {{ App\Models\AdminSetting::where('slug','site_name')->first() ? App\Models\AdminSetting::where('slug','site_name')->first()->value : config('variables.templateName')}}! 👋</h4>
                    <p class="mb-4">Please sign-in to your account and access the service</p>
